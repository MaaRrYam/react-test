...
import {ColoredIconProps} from '@/interfaces';

interface CrossIconProps extends ColoredIconProps {
  iconContainerStyles?: Object;
}

const Cross = ({iconContainerStyles, color}: CrossIconProps) => {
  return (
    <View style={[styles.container, iconContainerStyles]}>
